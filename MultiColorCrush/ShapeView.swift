...
//            if currentSwitch == 0 {
//
//                currentSwitch = Int(arc4random_uniform(UInt32(2))) + 1
//
//            }
//        }
    }
            ...
            case 3:
                ...
                if currentSwitch == 1 {
                    ...
                    if isLocked == false && doesPivot == true {
                        ...
                        addPivotRect(context: context2, side: "bottom", color: colors[0])
                    }
            ...
            case 2:
                ...
                if currentSwitch == 1 {
                    ...
                    if isLocked == false && doesPivot == true {
                        ...
                        addPivotRect(context: context2, side: "left", color: colors[0])
                    }
